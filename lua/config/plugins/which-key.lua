...
local mappings = {
  ...
  { "<leader>f", "<cmd>Telescope find_files hidden=true<cr>", desc = "find_files", nowait = true, remap = false },
  { "<leader>F", "<cmd>Telescope live_grep<cr>", desc = "live_grep", nowait = true, remap = false },
  ...
  { "<leader>lf", "<cmd>lua require 'conform'.format({ async = true })<cr>", desc = "Format", nowait = true, remap = false },
